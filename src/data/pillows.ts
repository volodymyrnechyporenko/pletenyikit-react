const pillows = [
  {
    ...
    materials:
      'Матеріали: акрил (пряжа), холофайбер (наповнення). Плетіння: спиці та гачок.',
  ...
  },
  {
    ...
    materials:
      'Матеріали: акрил (пряжа), пластик (очі), холофайбер (наповнювач).',
  ...
  {
    id: 50,
    name: 'Котоджентльмент з чубчиком',
    description:
      "Хто сказав, що котику не можна носити штанці на підтяжках і довгу гривку? Звісно котикам можна вдягати будь що, бо їм все пасує. Яскраве поєднання блакитного та бірюзово-малинового - чудово виглядає на цьому котоПодухові. Він - неймовірно пухнастий, м'якенький та легенький, і вже готовий оселятись на ваших диванах чи ліжках.",
    materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
    dimensions: 'Розмір: 32/32/12см.',
    images: [
      'kotogentleman-z-chubchykom-01.jpeg',
      'kotogentleman-z-chubchykom-02.jpeg',
      'kotogentleman-z-chubchykom-03.jpeg',
      'kotogentleman-z-chubchykom-04.jpeg',
      'kotogentleman-z-chubchykom-05.jpeg',
      'kotogentleman-z-chubchykom-06.jpeg',
    ],
    price: 1200,
    link: 'kotogentleman-z-chubchykom',
    category: 'Подушки',
    similar: [
      {
        img: 'kotogentleman-koliorovyi-01.jpeg',
        price: 1200,
        link: 'kotogentleman-koliorovyi',
      },
    ],
  },
  {
    id: 51,
    name: 'Котоджентльмен кольоровий',
    description:
      "Хто сказав, що котику не можна носити штанці на підтяжках і довгу гривку? Звісно котикам можна вдягати будь що, бо їм все пасує. Яскраве поєднання блакитного та бірюзово-малинового - чудово виглядає на цьому котоПодухові. Він - неймовірно пухнастий, м'якенький та легенький, і вже готовий оселятись на ваших диванах чи ліжках.",
    materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
    dimensions: 'Розмір: 32/30/12см.',
    images: [
      'kotogentleman-koliorovyi-01.jpeg',
      'kotogentleman-koliorovyi-02.jpeg',
      'kotogentleman-koliorovyi-03.jpeg',
      'kotogentleman-koliorovyi-04.jpeg',
      'kotogentleman-koliorovyi-05.jpeg',
      'kotogentleman-koliorovyi-06.jpeg',
    ],
    price: 1200,
    link: 'kotogentleman-koliorovyi',
    category: 'Подушки',
    similar: [
      {
        img: 'kotogentleman-z-chubchykom-01.jpeg',
        price: 1200,
        link: 'kotogentleman-z-chubchykom',
      },
    ],
  },
  {
    ...
    name: 'Крис',
    description:
      "Такої подушкоІграшки в історії плетеного КоТа ще не було і ми дуже тішимось, що тепер вона є, бо вона - чудова! Величезна, м'якезна ПацюкоПодушка до вашої уваги.",
    materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
    dimensions: 'Розмір: 60/32/15см.',
    images: [
      'krys-01.jpeg',
      'krys-02.jpeg',
      'krys-03.jpeg',
  ...
  {
    id: 53,
    name: 'Молочно-бузковий подух',
    description:
      "Неймовірно гарне ручне плетіння поєднало в собі молочну та бузкову меланжеву пряжі і з'явився чудовий та фактурний котик. М'який, приємний на дотик та тепленький КотоПодух - легко прикрасить вашу оселю, або ж - стане чудовим подарунком.",
    materials:
      "Матеріали: акрил (пряжа), холофайбер (наповнювач). Мордочка вишита вручну, а лапки м'якенькі та рухомі.",
    dimensions: 'Розмір: 32/32/13см.',
    images: [
      'molochno-buzkovyi-podukh-01.jpeg',
      'molochno-buzkovyi-podukh-02.jpeg',
      'molochno-buzkovyi-podukh-03.jpeg',
      'molochno-buzkovyi-podukh-04.jpeg',
      'molochno-buzkovyi-podukh-05.jpeg',
      'molochno-buzkovyi-podukh-06.jpeg',
      'molochno-buzkovyi-podukh-07.jpeg',
    ],
    price: 900,
    link: 'molochno-buzkovyi-podukh',
    category: 'Подушки',
  },
  {
    id: 54,
    name: 'Рожевоносий товстунчик',
    description:
      'Ця модель котоПодуха - одна з найпопулярніших і може здатись, що таких подушок було вже багато, але, якщо порівняти всі, сплетені в попередні роки подушки-іграшки такої моделі, ви не знайдете подібних. Так як ми використовуємо нитки повторно, підібрати однакові для виробів важко і повторюються в схожих кольорах лише деякі моделі, якщо, наприклад, було розпущено якесь покривало чи великий светр. Тож, всі товстенькі сірі котики - неповторні, бо сірі ниточки гарної якості не так часто зустрічаються.',
    materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
    dimensions: 'Розмір: 45/29/19см.',
    images: [
      'siryi-tovstunchyk-01.jpeg',
      'siryi-tovstunchyk-02.jpeg',
      'siryi-tovstunchyk-03.jpeg',
      'siryi-tovstunchyk-04.jpeg',
      'siryi-tovstunchyk-05.jpeg',
      'siryi-tovstunchyk-06.jpeg',
      'siryi-tovstunchyk-07.jpeg',
    ],
    price: 1200,
    link: 'siryi-tovstunchyk',
    category: 'Подушки',
    similar: [
      {
        img: 'smuhach-01.jpeg',
  ...
  },
  {
    ...
    name: 'Смугач',
    description:
      'Смугач - одна з найпопулярніших моделей котоПодухів. Може здатись, що таких подушок було вже багато, але, якщо порівняти всі, сплетені в попередні роки подушки-іграшки такої моделі, ви не знайдете подібних. Так як ми використовуємо нитки повторно, підібрати однакові для виробів важко і повторюються в схожих кольорах лише деякі моделі, якщо, наприклад, було розпущено якесь покривало чи великий светр. Тож, всі товстенькі сірі котики - неповторні, бо сірі ниточки гарної якості не так часто зустрічаються.',
    materials: 'Матеріали: акрил (пряжа), холофайбер (наповнювач).',
    dimensions: 'Розмір: 38/28/15см.',
    images: [
      'smuhach-01.jpeg',
      'smuhach-02.jpeg',
      'smuhach-03.jpeg',
